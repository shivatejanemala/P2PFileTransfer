...
public class FileManager {
    ...
    private final Collection<FileManagerListenerInterface> fileManagerListeners = new LinkedList<>();
    ...
    public synchronized void addPiece (int pieceId, byte[] piece) {
       ...
       // Determine whether it is a piece which peer doesnt have and write the piece on to a file if its new piece
        ...
        if (isNewPiece) {
            ...
            for (FileManagerListenerInterface listener : fileManagerListeners) {
    ...
    public void registerListener (FileManagerListenerInterface listener) {
	...
	public BitSet getIsPieceAvailable() {
